...
const {login, logout, createAccountForCustomer, changePassword, forgotPassword, loginAdmin, verify, accessForgotPassword, updateProfile} = require("../controllers/account.controllers");
...
accountRouter.post("/updateprofile", authenticate, updateProfile);
